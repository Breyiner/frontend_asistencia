            ...
            left: [
                {
                    ...
                    content: (
                        <div className="attendances-register__container-title">
                            <span className="attendances-register__title">Registro de Asistencias</span>
                            <div className="attendances-register__content">{payload?.ficha?.training_program?.name || "—"}</div>
                            <div className="attendances-register__content">Ficha {payload?.ficha?.ficha_number || "-"} - {payload?.ficha?.shift_mode || "—"}</div>
                        </div>
                    ),
                },
            ]
