            ...
            left: [
                {
                    content: (
                        <>
                            <InputField label="Trimestre" name="term_id" value={form.term_id} onChange={onChange} options={termsCatalog.options} disabled={termsCatalog.loading || loading} error={errors.term_id} select />
                            <InputField label="Fase" name="phase_id" value={form.phase_id} onChange={onChange} options={phasesCatalog.options} disabled={phasesCatalog.loading || loading} error={errors.phase_id} select />
                        </>
                    ),
                },
            ],
            right: [
                {
                    content: (
                        <>
                            <InputField label="Fecha Inicio" name="start_date" type="date" value={form.start_date} disabled={loading} onChange={onChange} error={errors.start_date} />
                            <InputField label="Fecha Fin" name="end_date" type="date" value={form.end_date} disabled={loading} onChange={onChange} error={errors.end_date} />
                        </>
                    ),
                },
            ],
